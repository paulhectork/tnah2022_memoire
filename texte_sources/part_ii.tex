...
\begin{figure}[p]
	...
	\tikz{
		...
		\node[baseoutline] at (-4,-9) {NON};
		\node[baseoutline] at (-1.1,-8.5) {OUI};
...
% en conclu de partie ou en conclu tout court
...
, dans un premier temps, d'identifier des éléments pertinents dans un contexte de recherche; dans un deuxième temps, il est possible 
