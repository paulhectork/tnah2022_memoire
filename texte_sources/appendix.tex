...
\begin{figure}[p]
	\centering
	\includegraphics[width=0.8\textheight,angle=-90]{annexes/roberto.jpg}
	\caption{Roberto, mascotte de l'Observatoire des humanités numériques de l'ENS}
	\label{appendix:roberto}
\end{figure}