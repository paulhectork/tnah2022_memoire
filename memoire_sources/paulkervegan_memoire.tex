...
\begin{figure}[!p]
	...
	\tikz[node distance=1cm, scale=0.70, transform shape]{
		...
		\node[base]%
			(tname) at (-3,0)%
			{Étape 2 -- Extraction de données du \tname{}};
		\node[transf]%
			(rebuild) at (7,-4)%
