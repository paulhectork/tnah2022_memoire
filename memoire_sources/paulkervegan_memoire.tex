...
%\begin{figure}[h!]
%	\tikz{
%		\node[draw,rectangle,rounded corners=3pt,text centered,text width=4cm]
%			(S) at (0,0)%
%			{Sujet \\ La ressource principale \\ \textit{Natalia Gontcharova}}
%		\node[draw,rectangle,rounded corners=3pt,text centered,text width=4cm]%
%			(P) at (0, 1)%
%			{Prédicat \\ La relation à l'objet \\ \textit{a peint}}
%		\node[draw,rectangle,rounded corners=3pt,text centered,text width=4cm]%
%			(O) at (0, 2)%
%			{Objet \\ Une ressource secondaire \\ \textit{Les porteuses}}
%	}
