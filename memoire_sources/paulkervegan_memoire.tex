...
Cette chaîne de traitement étant lancée sur plus de 80000 entrées de catalogues, le temps d'exécution est très long; dans sa version initiale, le script demandait des performances particulièrement élevées, et ne fonctionnait pas sur un ordinateur \enquote{simple}. La chaîne de traitement a donc été reprise en plusieurs points afin d'être optimisée et de fonctionner plus vite en étant moins coûteuse en ressources.
